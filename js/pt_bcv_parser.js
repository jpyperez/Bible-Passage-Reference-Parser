(function () {
  ...
  bcv_parser = (function () {
    ...
    bcv_parser.prototype.parse_with_context = function (s, context) {
      ...
      (ref1 = this.match_passages(context)),
        (entities = ref1[0]),
        (context = ref1[1]);
      this.reset();
      this.s = s;
      s = this.replace_control_characters(s);
      (ref2 = this.match_books(s)),
        (s = ref2[0]),
        (this.passage.books = ref2[1]);
    ...
    bcv_parser.prototype.versification_system = function (system) {
      ...
      if (system !== "default" && this.translations[system].order != null) {
        if ((base1 = this.translations.alternates["default"]).order == null) {
          base1.order = bcv_utils.shallow_clone(
      ...
      if (system !== "default" && this.translations[system].chapters != null) {
        ...
        for (book in ref1) {
          ...
          if (
            (base2 = this.translations.alternates["default"].chapters)[book] ==
            null
          ) {
    ...
    bcv_parser.prototype.translation_info = function (new_translation) {
      ...
      if (
        ...
        ((ref = this.translations.aliases[new_translation]) != null
          ? ref.alias
          : void 0) != null
      ) {
      ...
      if (
        !(new_translation != null && this.translations[new_translation] != null)
      ) {
        new_translation = "default";
      }
    ...
    bcv_parser.prototype.match_passages = function (s) {
      ...
      while ((match = this.regexps.escaped_passage.exec(s))) {
        ...
        (ref = this.passage.handle_obj(passage)),
          (accum = ref[0]),
          (post_context = ref[1]);
    ...
    bcv_parser.prototype.adjust_regexp_end = function (
      accum,
      old_length,
      new_length
    ) {
      ...
      if (accum.length > 0) {
        regexp_index_adjust =
          old_length - accum[accum.length - 1].indices[1] - 1;
    ...
    bcv_parser.prototype.add_book_range_object = function (
      passage,
      prev,
      start_book_number
    ) {
      ...
      for (
        ...
        if (
          ((ref1 = passage.value[i].value[0]) != null
            ? ref1.indices
            : void 0) != null
        ) {
    ...
    bcv_parser.prototype.to_osis = function (start, end, translation) {
      ...
      if (
        ...
        osis.start =
          start.b + "." + start.c.toString() + "." + start.v.toString();
    ...
    bcv_parser.prototype.fix_ps151 = function (start, end, translation) {
      ...
      if (
        translation !== "default" &&
        ((ref = this.translations[translation]) != null
          ? ref.chapters["Ps151"]
          : void 0) == null
      ) {
      ...
      if (start.c === 151 && start.b === "Ps") {
        ...
        return (end.v =
          this.passage.translations[translation].chapters["Ps"][149]);
      }
    };

    bcv_parser.prototype.combine_consecutive_passages = function (
      osises,
      translation
    ) {
      var enclosed_sequence_start,
        has_enclosed,
        i,
        is_enclosed_last,
        k,
    ...
    bcv_parser.prototype.is_verse_consecutive = function (
      prev,
      check,
      translation
    ) {
    ...
    bcv_parser.prototype.snap_sequence = function (
      type,
      entity,
      osises,
      i,
      ...
      if (
        ...
        entity.passages[i + 1].absolute_indices[0] =
          passage.absolute_indices[0];
      }
      return entity;
    };
    ...
    bcv_parser.prototype.remove_absolute_indices = function (passages, i) {
      ...
      (ref = passages[i].enclosed_absolute_indices),
        (start = ref[0]),
        (end = ref[1]);
  ...
  bcv_passage = (function () {
    ...
    bcv_passage.prototype.bcv = function (passage, accum, context) {
      ...
      for (k = 0, len = ref.length; k < len; k++) {
        ...
        (ref1 = this.fix_start_zeroes(valid, c, v)),
          (c = ref1[0]),
          (v = ref1[1]);
        obj = {
          start: {
    ...
    bcv_passage.prototype.sequence_post_enclosed = function (
      passage,
      accum,
      context
    ) {
    ...
    bcv_passage.prototype.range_change_end = function (
      passage,
      accum,
      new_end
    ) {
    ...
    bcv_passage.prototype.range_get_new_end_value = function (
      start_obj,
      end_obj,
      valid,
      key
    ...
    bcv_passage.prototype.range_validate = function (
      valid,
      start_obj,
      end_obj,
      passage
    ...
    bcv_passage.prototype.translation_sequence = function (
      passage,
      accum,
      context
    ) {
      ...
      for (l = 0, len1 = translations.length; l < len1; l++) {
        ...
        if (this.translations.aliases[translation.translation] != null) {
          translation.alias =
            this.translations.aliases[translation.translation].alias;
          translation.osis =
    ...
    bcv_passage.prototype.translation_sequence_apply = function (
      accum,
      translations
    ) {
      ...
      if (use_i < accum.length) {
        ...
        context = bcv_utils.shallow_clone(
          accum[accum.length - 1].start_context
        );
      }
      return context;
    };
    ...
    bcv_passage.prototype.pluck = function (type, passages) {
      ...
      for (k = 0, len = passages.length; k < len; k++) {
        passage = passages[k];
        if (
          !(passage != null && passage.type != null && passage.type === type)
        ) {
          continue;
        }
        if (type === "c" || type === "v") {
    ...
    bcv_passage.prototype.set_context_from_object = function (
      context,
      keys,
      obj
    ) {
    ...
    bcv_passage.prototype.validate_ref = function (translations, start, end) {
      ...
      for (k = 0, len = translations.length; k < len; k++) {
        ...
        temp_valid = this.validate_start_ref(
          translation.alias,
          start,
          messages
        )[0];
    ...
    bcv_passage.prototype.validate_start_ref = function (
      translation,
      start,
      messages
    ) {
      ...
      if (
        translation !== "default" &&
        ((ref = this.translations[translation]) != null
          ? ref.chapters[start.b]
          : void 0) == null
      ) {
        this.promote_book_to_translation(start.b, translation);
      }
      translation_order =
        ((ref1 = this.translations[translation]) != null
          ? ref1.order
          : void 0) != null
          ? translation
          : "default";
    ...
    bcv_passage.prototype.validate_end_ref = function (
      ...
      translation_order =
        ((ref = this.translations[translation]) != null ? ref.order : void 0) !=
        null
          ? translation
          : "default";
      if (end.c != null) {
      ...
      if (this.translations[translation_order].order[end.b] != null) {
        ...
        if (end.c != null && !isNaN(end.c)) {
          if (
            this.translations[translation].chapters[end.b][end.c - 1] == null
          ) {
    ...
    bcv_passage.prototype.promote_book_to_translation = function (
      book,
      translation
    ) {
      var base, base1;
  ...
  bcv_parser.prototype.regexps.escaped_passage = RegExp(
    "(?:^|[^\\x1f\\x1e\\dA-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:(?:ch(?:apters?|a?pts?\\.?|a?p?s?\\.?)?\\s*\\d+\\s*(?:[\\u2013\\u2014\\-]|through|thru|to)\\s*\\d+\\s*(?:from|of|in)(?:\\s+the\\s+book\\s+of)?\\s*)|(?:ch(?:apters?|a?pts?\\.?|a?p?s?\\.?)?\\s*\\d+\\s*(?:from|of|in)(?:\\s+the\\s+book\\s+of)?\\s*)|(?:\\d+(?:th|nd|st)\\s*ch(?:apter|a?pt\\.?|a?p?\\.?)?\\s*(?:from|of|in)(?:\\s+the\\s+book\\s+of)?\\s*))?\\x1f(\\d+)(?:/\\d+)?\\x1f(?:/\\d+\\x1f|[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/\"'\\*=~\\-\\u2013\\u2014]|t[íi]tulo(?![a-z])|e(?!" +
      bcv_parser.prototype.regexps.space +
      "+sig)|e" +
      bcv_parser.prototype.regexps.space +
      "+sig|vers[íi]culos|cap[íi]tulos|vers[íi]culo|cap[íi]tulo|caps|vers|cap|ver|vss|vs|vv|á|v|[a-d](?!\\w)|$)+)",
    "gi"
  );

  bcv_parser.prototype.regexps.match_end_split = RegExp(
    "\\d\\W*t[íi]tulo|\\d\\W*e" +
      bcv_parser.prototype.regexps.space +
      "+sig(?:[\\s\\xa0*]*\\.)?|\\d[\\s\\xa0*]*[a-d](?!\\w)|\\x1e(?:[\\s\\xa0*]*[)\\]\\uff09])?|[\\d\\x1f]",
    "gi"
  );
  ...
  bcv_parser.prototype.regexps.first =
    "(?:Primeir[ao]|1[ao]?|I)\\.?" + bcv_parser.prototype.regexps.space + "*";

  bcv_parser.prototype.regexps.second =
    "(?:Segund[ao]|2[ao]?|II)\\.?" + bcv_parser.prototype.regexps.space + "*";

  bcv_parser.prototype.regexps.third =
    "(?:Terceir[ao]|3[ao]?|III)\\.?" + bcv_parser.prototype.regexps.space + "*";
  ...
  bcv_parser.prototype.regexps.get_books = function (
    include_apocrypha,
    case_sensitive
  ) {
    ...
    books = [
      ...
      },
      {
        ...
        regexp: RegExp(
          "(^|" +
            bcv_parser.prototype.regexps.pre_book +
            ")((?:G(?:[e\\xE9\\xEA]n(?:esis)?|n)))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)",
          "gi"
        ),
      },
      {
        ...
        regexp: RegExp(
          "(^|" +
            bcv_parser.prototype.regexps.pre_book +
            ")((?:[E\\xCA]x(?:o(?:do?)?|d)?|\\xC9xodo))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)",
          "gi"
        ),
      },
      {
        ...
        regexp: RegExp(
          "(^|" +
            bcv_parser.prototype.regexps.pre_book +
            ")((?:Bel(?:[\\s\\xa0]*e[\\s\\xa0]*o[\\s\\xa0]*[Dd]rag[a\\xE3]o)?))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)",
          "gi"
        ),
      },
      {
        ...
        regexp: RegExp(
          "(^|" +
            bcv_parser.prototype.regexps.pre_book +
            ")((?:L(?:e(?:v(?:[i\\xED]ticos?)?)?|v)))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)",
          "gi"
        ),
      },
      {
        ...
        regexp: RegExp(
          "(^|" +
            bcv_parser.prototype.regexps.pre_book +
            ")((?:N(?:[u\\xFA](?:m(?:eros)?)?|m)))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)",
          "gi"
        ),
      },
      {
        ...
        regexp: RegExp(
          "(^|" +
            bcv_parser.prototype.regexps.pre_book +
            ")((?:Sir(?:[a\\xE1]cida)?|Eclesi[a\\xE1]stico))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)",
          "gi"
        ),
      },
      {
        ...
        regexp: RegExp(
          "(^|" +
            bcv_parser.prototype.regexps.pre_book +
            ")((?:S(?:ab(?:edoria(?:[\\s\\xa0]*de[\\s\\xa0]*Salom[a\\xE3]o)?)?|b)|Wis))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)",
          "gi"
        ),
      },
      {
        ...
        regexp: RegExp(
          "(^|" +
            bcv_parser.prototype.regexps.pre_book +
            ")((?:L(?:am(?:enta[c\\xE7](?:[o\\xF5]es(?:[\\s\\xa0]*de[\\s\\xa0]*Jeremias)?|\\xF4es[\\s\\xa0]*de[\\s\\xa0]*Jeremias))?|m)))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)",
          "gi"
        ),
      },
      {
        ...
        regexp: RegExp(
          "(^|" +
            bcv_parser.prototype.regexps.pre_book +
            ")((?:Cart(?:a[\\s\\xa0]*de[\\s\\xa0]*Jeremias|\\.?[\\s\\xa0]*Jer)|EpJer))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)",
          "gi"
        ),
      },
      {
        ...
        regexp: RegExp(
          "(^|" +
            bcv_parser.prototype.regexps.pre_book +
            ")((?:Ap(?:oc(?:alipse(?:[\\s\\xa0]*de[\\s\\xa0]*(?:S[a\\xE3]o[\\s\\xa0]*Jo[a\\xE3]|Jo[a\\xE3])o)?)?|c)?|Rev))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)",
          "gi"
        ),
      },
      {
        ...
        regexp: RegExp(
          "(^|" +
            bcv_parser.prototype.regexps.pre_book +
            ")((?:Pr(?:ece[\\s\\xa0]*de[\\s\\xa0]*Manass[e\\xE9]s|[\\s\\xa0]*?Man)))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)",
          "gi"
        ),
      },
      {
        ...
        regexp: RegExp(
          "(^|" +
            bcv_parser.prototype.regexps.pre_book +
            ")((?:D(?:eu(?:t(?:eron[o\\xF3\\xF4]mio)?)?|t)))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)",
          "gi"
        ),
      },
      {
        ...
        regexp: RegExp(
          "(^|" +
            bcv_parser.prototype.regexps.pre_book +
            ")((?:J(?:os(?:u[e\\xE9]|h)?|s)))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)",
          "gi"
        ),
      },
      {
        ...
        regexp: RegExp(
          "(^|" +
            bcv_parser.prototype.regexps.pre_book +
            ")((?:J(?:u(?:[i\\xED]z(?:es)?|dg)|z)))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)",
          "gi"
        ),
      },
      {
      ...
      },
      {
        ...
        apocrypha: true,
        regexp:
          /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:2[\s\xa0]*Esdras)|(?:(?:2[ao]|II)[\s\xa0]*Esdras|2(?:[\s\xa0]*?Esd|[\s\xa0]*Es)|(?:2[ao]?|II)\.[\s\xa0]*Esdras|Segund[ao][\s\xa0]*Esdras))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi,
      },
      {
        osis: ["1Esd"],
        apocrypha: true,
        regexp:
          /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:1[\s\xa0]*Esdras)|(?:(?:1[ao]|I)[\s\xa0]*Esdras|1(?:[\s\xa0]*?Esd|[\s\xa0]*Es)|(?:1[ao]?|I)\.[\s\xa0]*Esdras|Primeir[ao][\s\xa0]*Esdras))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi,
      },
      {
        osis: ["Isa"],
        regexp: RegExp(
      ...
      },
      {
        osis: ["2Sam"],
        regexp:
          /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:2(?:(?:[\s\xa0]*S|Sa)m|[\s\xa0]*Samuel|[\s\xa0]*S(?:am?)?|[\s\xa0]*Reinos)|(?:2[ao]|II)[\s\xa0]*(?:Reinos|Samuel)|(?:2[ao]?|II)\.[\s\xa0]*(?:Reinos|Samuel)|Segund[ao][\s\xa0]*(?:Reinos|Samuel)))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi,
      },
      {
        osis: ["1Sam"],
        regexp:
          /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:1(?:(?:[\s\xa0]*S|Sa)m|[\s\xa0]*Samuel|[\s\xa0]*S(?:am?)?|[\s\xa0]*Reinos)|(?:1[ao]|I)[\s\xa0]*(?:Reinos|Samuel)|(?:1[ao]?|I)\.[\s\xa0]*(?:Reinos|Samuel)|Primeir[ao][\s\xa0]*(?:Reinos|Samuel)))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi,
      },
      {
        osis: ["2Kgs"],
        regexp:
          /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:(?:(?:2[ao]|II)[\s\xa0]*Rei|2(?:[\s\xa0]*Rei|Kg)|(?:2[ao]?|II)\.[\s\xa0]*Rei|Segund[ao][\s\xa0]*Rei)s|2[\s\xa0]*R(?:e|s)?|(?:4[ao]?|IV)[\s\xa0]*Reinos|(?:4[ao]?|IV)\.[\s\xa0]*Reinos|Quart[ao][\s\xa0]*Reinos))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi,
      },
      {
        osis: ["1Kgs"],
        regexp:
          /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:(?:(?:1[ao]|I)[\s\xa0]*Rei|1(?:[\s\xa0]*Rei|Kg)|(?:1[ao]?|I)\.[\s\xa0]*Rei|Primeir[ao][\s\xa0]*Rei)s|1[\s\xa0]*R(?:e|s)?|(?:3[ao]?|III)[\s\xa0]*Reinos|(?:3[ao]?|III)\.[\s\xa0]*Reinos|Terceir[ao][\s\xa0]*Reinos))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi,
      },
      {
        osis: ["2Chr"],
        regexp:
          /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:2[\s\xa0]*Cr[o\xF4]nicas)|(?:2(?:[\s\xa0]*Cr[o\xF4]n|Chr|[\s\xa0]*Cr[o\xF4]?)|(?:2[ao]|II)[\s\xa0]*Cr[o\xF4]nicas|(?:2[ao]?|II)\.[\s\xa0]*Cr[o\xF4]nicas|Segund[ao][\s\xa0]*Cr[o\xF4]nicas))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi,
      },
      {
        osis: ["1Chr"],
        regexp:
          /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:1[\s\xa0]*Cr[o\xF4]nicas)|(?:1(?:[\s\xa0]*Cr[o\xF4]n|Chr|[\s\xa0]*Cr[o\xF4]?)|(?:1[ao]|I)[\s\xa0]*Cr[o\xF4]nicas|(?:1[ao]?|I)\.[\s\xa0]*Cr[o\xF4]nicas|Primeir[ao][\s\xa0]*Cr[o\xF4]nicas))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi,
      },
      {
        osis: ["Ezra"],
        regexp: RegExp(
          "(^|" +
            bcv_parser.prototype.regexps.pre_book +
            ")((?:E(?:sd(?:r(?:as)?)?|zra|d)))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)",
          "gi"
        ),
      },
      {
      ...
      },
      {
        ...
        regexp: RegExp(
          "(^|" +
            bcv_parser.prototype.regexps.pre_book +
            ")((?:Est(?:er[\\s\\xa0]*(?:\\([Gg]rega\\)|[Gg]rega)|[\\s\\xa0]*\\(Gr\\))|GkEsth))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)",
          "gi"
        ),
      },
      {
      ...
      },
      {
        ...
        regexp: RegExp(
          "(^|" +
            bcv_parser.prototype.regexps.pre_book +
            ")((?:Sal(?:mo[\\s\\xa0]*de[\\s\\xa0]*Azarias|[\\s\\xa0]*Azar)|PrAzar))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)",
          "gi"
        ),
      },
      {
      ...
      },
      {
        ...
        regexp: RegExp(
          "(^|" +
            bcv_parser.prototype.regexps.pre_book +
            ")((?:P(?:r(?:o(?:v(?:[e\\xE9]rbios)?)?|v)?|v)))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)",
          "gi"
        ),
      },
      {
        ...
        regexp: RegExp(
          "(^|" +
            bcv_parser.prototype.regexps.pre_book +
            ")((?:Ec(?:l(?:esiastes)?|cl)?|Co[e\\xE9]let))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)",
          "gi"
        ),
      },
      {
        ...
        apocrypha: true,
        regexp:
          /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:C(?:[a\xE2]ntico[\s\xa0]*dos[\s\xa0]*(?:Tr[e\xEA]s|3)[\s\xa0]*Jovens|3J)|SgThree))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi,
      },
      {
        osis: ["Song"],
        regexp: RegExp(
      ...
      },
      {
        ...
        regexp: RegExp(
          "(^|" +
            bcv_parser.prototype.regexps.pre_book +
            ")((?:Os(?:[e\\xE9]ias)?|Hos))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)",
          "gi"
        ),
      },
      {
      ...
      },
      {
        ...
        regexp: RegExp(
          "(^|" +
            bcv_parser.prototype.regexps.pre_book +
            ")((?:Ob(?:a(?:d(?:ias)?)?|d)?|Abd(?:ias)?))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)",
          "gi"
        ),
      },
      {
      ...
      },
      {
        ...
        regexp: RegExp(
          "(^|" +
            bcv_parser.prototype.regexps.pre_book +
            ")((?:M(?:i(?:q(?:u[e\\xE9]ias)?|c)|q)))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)",
          "gi"
        ),
      },
      {
      ...
      },
      {
        ...
        regexp: RegExp(
          "(^|" +
            bcv_parser.prototype.regexps.pre_book +
            ")((?:H(?:ab(?:acu(?:que|c))?|c)))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)",
          "gi"
        ),
      },
      {
        ...
        regexp: RegExp(
          "(^|" +
            bcv_parser.prototype.regexps.pre_book +
            ")((?:S(?:of(?:onias)?|f)|Zeph))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)",
          "gi"
        ),
      },
      {
      ...
      },
      {
        ...
        regexp: RegExp(
          "(^|" +
            bcv_parser.prototype.regexps.pre_book +
            ")((?:Z(?:ac(?:arias)?|ech|c)))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)",
          "gi"
        ),
      },
      {
      ...
      },
      {
        ...
        apocrypha: true,
        regexp:
          /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:1[\s\xa0]*Macabeus)|(?:1Macc)|(?:(?:1[ao]|I)[\s\xa0]*Macabeus|1[\s\xa0]*M(?:a?c)?|(?:1[ao]?|I)\.[\s\xa0]*Macabeus|Primeir[ao][\s\xa0]*Macabeus))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi,
      },
      {
        osis: ["2Macc"],
        apocrypha: true,
        regexp:
          /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:2[\s\xa0]*Macabeus)|(?:2Macc)|(?:(?:2[ao]|II)[\s\xa0]*Macabeus|2[\s\xa0]*M(?:a?c)?|(?:2[ao]?|II)\.[\s\xa0]*Macabeus|Segund[ao][\s\xa0]*Macabeus))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi,
      },
      {
        osis: ["3Macc"],
        apocrypha: true,
        regexp:
          /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:3[\s\xa0]*Macabeus)|(?:3Macc)|(?:(?:3[ao]|III)[\s\xa0]*Macabeus|3[\s\xa0]*M(?:a?c)?|(?:3[ao]?|III)\.[\s\xa0]*Macabeus|Terceir[ao][\s\xa0]*Macabeus))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi,
      },
      {
        osis: ["4Macc"],
        apocrypha: true,
        regexp:
          /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:4[\s\xa0]*Macabeus)|(?:4Macc)|(?:(?:4[ao]|IV)[\s\xa0]*Macabeus|4[\s\xa0]*M(?:a?c)?|(?:4[ao]?|IV)\.[\s\xa0]*Macabeus|Quart[ao][\s\xa0]*Macabeus))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi,
      },
      {
        osis: ["Mark"],
        regexp: RegExp(
          "(^|" +
            bcv_parser.prototype.regexps.pre_book +
            ")((?:M(?:ar(?:cos|\\.|k)?|c|rc)))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)",
          "gi"
        ),
      },
      {
      ...
      },
      {
        osis: ["1John"],
        regexp:
          /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:1John)|(?:(?:1[ao]|I)[\s\xa0]*Jo[a\xE3]o|1[\s\xa0]*J(?:o[a\xE3]o|o)?|(?:1[ao]?|I)\.[\s\xa0]*Jo[a\xE3]o|Primeir[ao][\s\xa0]*Jo[a\xE3]o))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi,
      },
      {
        osis: ["2John"],
        regexp:
          /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:2John)|(?:(?:2[ao]|II)[\s\xa0]*Jo[a\xE3]o|2[\s\xa0]*J(?:o[a\xE3]o|o)?|(?:2[ao]?|II)\.[\s\xa0]*Jo[a\xE3]o|Segund[ao][\s\xa0]*Jo[a\xE3]o))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi,
      },
      {
        osis: ["3John"],
        regexp:
          /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:3John)|(?:(?:3[ao]|III)[\s\xa0]*Jo[a\xE3]o|3[\s\xa0]*J(?:o[a\xE3]o|o)?|(?:3[ao]?|III)\.[\s\xa0]*Jo[a\xE3]o|Terceir[ao][\s\xa0]*Jo[a\xE3]o))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi,
      },
      {
        osis: ["John"],
        regexp: RegExp(
      ...
      },
      {
        ...
        regexp: RegExp(
          "(^|" +
            bcv_parser.prototype.regexps.pre_book +
            ")((?:A(?:t(?:os(?:[\\s\\xa0]*dos[\\s\\xa0]*Ap[o\\xF3]stolos)?)?|cts)))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)",
          "gi"
        ),
      },
      {
      ...
      },
      {
        osis: ["2Cor"],
        regexp:
          /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:2(?:[\s\xa0]*Cor[i\xED]ntios|[\s\xa0]*Cor?|Cor)|(?:2[ao]|II)[\s\xa0]*Cor[i\xED]ntios|(?:2[ao]?|II)\.[\s\xa0]*Cor[i\xED]ntios|Segund[ao][\s\xa0]*Cor[i\xED]ntios|II[\s\xa0]*Cor\.|II[\s\xa0]*Cor))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi,
      },
      {
        osis: ["1Cor"],
        regexp:
          /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:1(?:[\s\xa0]*Cor[i\xED]ntios|[\s\xa0]*Cor?|Cor)|(?:1[ao]|I)[\s\xa0]*Cor[i\xED]ntios|(?:1[ao]?|I)\.[\s\xa0]*Cor[i\xED]ntios|Primeir[ao][\s\xa0]*Cor[i\xED]ntios|I[\s\xa0]*Cor\.|I[\s\xa0]*Cor))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi,
      },
      {
        osis: ["Gal"],
        regexp: RegExp(
          "(^|" +
            bcv_parser.prototype.regexps.pre_book +
            ")((?:G(?:[a\\xE1]l(?:atas)?|l)))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)",
          "gi"
        ),
      },
      {
        ...
        regexp: RegExp(
          "(^|" +
            bcv_parser.prototype.regexps.pre_book +
            ")((?:E(?:f(?:[e\\xE9]sios)?|ph)))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)",
          "gi"
        ),
      },
      {
        ...
        regexp: RegExp(
          "(^|" +
            bcv_parser.prototype.regexps.pre_book +
            ")((?:F(?:il(?:ipenses)?|[lp])|Phil))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)",
          "gi"
        ),
      },
      {
        ...
        regexp: RegExp(
          "(^|" +
            bcv_parser.prototype.regexps.pre_book +
            ")((?:C(?:ol(?:ossenses)?|l)))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)",
          "gi"
        ),
      },
      {
        osis: ["2Thess"],
        regexp:
          /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:(?:2(?:[\s\xa0]*Tessalonicense|[\s\xa0]*T(?:es)?|Thes)|(?:2[ao]|II)[\s\xa0]*Tessalonicense|(?:2[ao]?|II)\.[\s\xa0]*Tessalonicense|Segund[ao][\s\xa0]*Tessalonicense)s))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi,
      },
      {
        osis: ["1Thess"],
        regexp:
          /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:(?:1(?:[\s\xa0]*Tessalonicense|[\s\xa0]*T(?:es)?|Thes)|(?:1[ao]|I)[\s\xa0]*Tessalonicense|(?:1[ao]?|I)\.[\s\xa0]*Tessalonicense|Primeir[ao][\s\xa0]*Tessalonicense)s))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi,
      },
      {
        osis: ["2Tim"],
        regexp:
          /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:2[\s\xa0]*Tim[o\xF3]teo)|(?:(?:2[ao]|II)[\s\xa0]*Tim[o\xF3]teo|2(?:(?:[\s\xa0]*Ti?|Ti)m|[\s\xa0]*Ti)|(?:2[ao]?|II)\.[\s\xa0]*Tim[o\xF3]teo|Segund[ao][\s\xa0]*Tim[o\xF3]teo))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi,
      },
      {
        osis: ["1Tim"],
        regexp:
          /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:1[\s\xa0]*Tim[o\xF3]teo)|(?:(?:1[ao]|I)[\s\xa0]*Tim[o\xF3]teo|1(?:(?:[\s\xa0]*Ti?|Ti)m|[\s\xa0]*Ti)|(?:1[ao]?|I)\.[\s\xa0]*Tim[o\xF3]teo|Primeir[ao][\s\xa0]*Tim[o\xF3]teo))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi,
      },
      {
        osis: ["Titus"],
        regexp: RegExp(
      ...
      },
      {
        ...
        regexp: RegExp(
          "(^|" +
            bcv_parser.prototype.regexps.pre_book +
            ")((?:F(?:il(?:emo[mn]|\\xE9mon)|l?mn|l?m)|Phlm))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)",
          "gi"
        ),
      },
      {
      ...
      },
      {
        osis: ["2Pet"],
        regexp:
          /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:2(?:[\s\xa0]*Pedro|Pet))|(?:(?:2[ao]|II)[\s\xa0]*Pedro|2[\s\xa0]*Ped?|(?:2[ao]?|II)\.[\s\xa0]*Pedro|Segund[ao][\s\xa0]*Pedro))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi,
      },
      {
        osis: ["1Pet"],
        regexp:
          /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:1(?:[\s\xa0]*Pedro|Pet))|(?:(?:1[ao]|I)[\s\xa0]*Pedro|1[\s\xa0]*Ped?|(?:1[ao]?|I)\.[\s\xa0]*Pedro|Primeir[ao][\s\xa0]*Pedro))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi,
      },
      {
        osis: ["Jude"],
        regexp: RegExp(
      ...
      },
      {
        ...
        regexp: RegExp(
          "(^|" +
            bcv_parser.prototype.regexps.pre_book +
            ")((?:Hist[o\\xF3]ria[\\s\\xa0]*de[\\s\\xa0]*Susana|Sus(?:ana)?))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)",
          "gi"
        ),
      },
    ];
  ...
  bcv_parser.prototype.regexps.books = bcv_parser.prototype.regexps.get_books(
    false,
    "none"
  );
  var grammar;
  ...
  (function (root) {
    ...
    function peg$parse(input, options) {
      ...
      if (
        "punctuation_strategy" in options &&
        options.punctuation_strategy === "eu"
      ) {
